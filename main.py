...
parser.add_argument('--testA', dest='testA', default='/testA', help='testA folder')
parser.add_argument('--testB', dest='testB', default='/testB', help='testB folder')
...
parser.add_argument('--layers', dest='nb_layers', type=int, default=9, help='# of layers of resnet in a generator')
